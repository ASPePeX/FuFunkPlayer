...
import de.fufunk.player.R;

public class FuFunkPlayer extends Activity implements OnClickListener,
	...
	public void onClick(View v) {
		if (v.getId() == R.id.ButtonTestPlayPause) {
			 ...
			 */
			try {
				mediaPlayer.setDataSource(editTextSongURL.getText().toString()); // setup
																					// song
																					// from
